	...
	.then(function (states) {
		 ...
		 if ("undefined" !== typeof req.param('providerid') && req.param('providerid') != '' && req.param('providerid') != null)
		 {
			 ...
			 .then(function(providerData){
				return res.view("admin/practice/createpractice",{stateData:states,stripe:stripe,siteUrl:sails.config.getBaseUrl,interestTermsArr:sails.config.plaid.interestTermsArr,StateCode:providerData.state,City:providerData.city,contactemail:providerData.email,contactphoneNo:providerData.phonenumber,providername:providerData.providername});
		    })
		 }
		 else
		 {
 	   	   return res.view("admin/practice/createpractice",{stateData:states,stripe:stripe,siteUrl:sails.config.getBaseUrl,interestTermsArr:sails.config.plaid.interestTermsArr});
		 }
	})
	.catch(function (err) {
        ...
        LoanSettings
            ...
            .then(function (termData) {
                ...
                State
                    ...
                    .getExistingPracticeState()
                    .then(function (states) {
                        return res.view("admin/practice/editpractice", { schoolData: schoolData, termData:termData, errorval: errorval, successval: successval, stateData: states, siteUrl: sails.config.getBaseUrl, disableValue: 1,interestTermsArr:sails.config.plaid.interestTermsArr });
                    })
                    .catch(function (err) {
        ...
        LoanSettings
            ...
            .then(function (termData) {
                ...
                State
                    ...
                    .getExistingPracticeState()
                    .then(function (states) {
                        return res.view("admin/user/editpracticesetting", { schoolData: schoolData, termData:termData, errorval: errorval, successval: successval, stateData: states, siteUrl: sails.config.getBaseUrl });
                    })
                    .catch(function (err) {
                        sails.log.error('PracticeManagement#editpracticeAction :: err', err);
                        return res.handleError(err);
