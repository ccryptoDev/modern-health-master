...
function executeBTRs(assetReport) {
	...
	let max_trans_date = moment(); //trans_dates.reduce(function (a, b) { return a < b ? a : b; }); // find the oldest date
																...
																.then( function( logDetails ) {
																	...
																	PracticeUser.getPracticeDetails( linkedstaffArr, linkedDoctorArr ).then( function( linkedpracticeRes ) {
																		...
																		PlaidAssetReport.find().limit(1).then((assetReport) => {
																			...
																			const bankrules = (assetReport[0] && screentracking.rulesDetails && !screentracking.rulesDetails.banktransactionrules) ? executeBTRs(assetReport[0]) : [];
																			const btrHasLength = !assetReport ? false : true;
																			
																			if (screentracking.rulesDetails && !screentracking.rulesDetails.banktransactionrules) {
